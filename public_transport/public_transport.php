...
<body>
    ...
    <div class="d-flex flex-wrap justify-content-center py-3 mb-4 mt-5">
        <ul class="nav nav-underline nav-justified">
            ...
            <li class="nav-item"><a href="http://localhost/KARLA/public_transport.php" class="nav-link link-light active" aria-current="page"><svg
                        xmlns="http://www.w3.org/2000/svg" height="2em"
...
<script src="route_public_transport.js"></script>
</body>
