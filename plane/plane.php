...
<body>
    <div class="container col-xxl-8 px-4 py-5 mb-5 border-bottom">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div class="col-lg-6">
                <h1 class="display-5 fw-bold lh-1 mb-3">CO²-Rechner für Dienstreisen</h1>
                ...
                <a href="https://www.reallabor-karla.de/kontakt.php" target="_blank"><button type="button" class="btn btn-outline-light btn-lg px-4 me-md-2 custom-font">Kontakt </button></a>
                <a href="https://www.reallabor-karla.de/klimaschonend-reisen.php" target="_blank"><button type="button" class="btn btn-outline-light btn-lg px-4 custom-font">Projekt</button></a>
                </div>
            </div>
    ...
    <div class="d-flex flex-wrap justify-content-center py-3 mb-4 mt-5">
        <ul class="nav nav-underline nav-justified">
            <li class="nav-item"><a href="http://localhost/KARLA/car/car.php" class="nav-link link-light"><svg xmlns="http://www.w3.org/2000/svg" height="2em"
            ...
            <li class="nav-item"><a href="http://localhost/KARLA/plane/plane.php" class="nav-link link-light active" aria-current="page"><svg
    ...
    <div id="search">
        <input class="form-control mb-1" type="text" name="Start" id="Start" placeholder="Start">
        <input class="form-control mb-1" type="text" name="Goal" id="Goal" placeholder="Ziel">
        <button class="btn btn-outline-light btn-lg px-4 custom-font" id="calculateAirDistanceButton">CO²-Ausstoß
            berechnen</button>
    </div>
<script src="../plane/route_by_plane.js"></script>
</body>
