...
<body>
    ...
    <div class="d-flex flex-wrap justify-content-center py-3 mb-4 mt-5">
        <ul class="nav nav-underline nav-justified">
            ...
            <li class="nav-item"><a href="http://localhost/KARLA/bike/bike.php" class="nav-link link-light active" aria-current="page"><svg
                        xmlns="http://www.w3.org/2000/svg" height="2em"
                        viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                            svg {
...
<script src="../bike/route_by_bike.js"></script>
</body>
